...
ifeq ($(ENABLE_ARMCC), 1)
ASM_SOURCES += Drivers/CMSIS/CM3/DeviceSupport/ST/STM32F10x/startup/arm/$(ASM_SOURCE)
else # DISABLE_ARMCC
ASM_SOURCES += Drivers/CMSIS/CM3/DeviceSupport/ST/STM32F10x/startup/gcc_ride7/$(ASM_SOURCE)
endif # ENABLE_ARMCC
...
AS_DEFS += --pd "STM32F10X_MD SETA 1"
